    ...
    <div className="min-h-screen bg-bg-deep text-primary-text font-sans selection:bg-champagne-gold selection:text-primary-text">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 pt-36 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 items-start">
          ...
          <aside className="hidden lg:block lg:col-span-1 space-y-6 sticky top-32">
            {/* Category Filter */}
            <div className="space-y-2 pb-4 border-b border-border-custom">
              ...
              <select
                ...
                className="w-full bg-bg-card border border-border-custom p-2 px-3 text-[10px] uppercase tracking-wider font-semibold focus:outline-none text-primary-text cursor-pointer"
              >
                {categories.map((cat) => (
            ...
            <div className="fixed left-0 top-0 bottom-0 w-4/5 max-w-sm bg-bg-deep z-50 p-6 flex flex-col justify-between shadow-2xl overflow-y-auto">
              <div>
                ...
                <div className="mb-4 space-y-1">
                  <h4 className="font-serif text-xs font-bold uppercase tracking-wider text-muted-text">Category</h4>
                  <select
                    value={selectedCategory}
                    onChange={(e) => {
                    ...
                    className="w-full bg-bg-card border border-border-custom p-2 text-xs focus:outline-none focus:border-soft-gold text-primary-text cursor-pointer"
                  >
                    {categories.map((cat) => (
                      <option key={cat} value={cat}>
                        {cat}
                ...
                {/* Mobile Fabrics */}
                <div className="mb-4 space-y-1">
                  <h4 className="font-serif text-xs font-bold uppercase tracking-wider text-muted-text">Fabric</h4>
                  <select
                    value={selectedFabric}
                    onChange={(e) => {
                ...
                {/* Mobile Sizes */}
                <div className="mb-4 space-y-1">
                  <h4 className="font-serif text-xs font-bold uppercase tracking-wider text-muted-text">Size</h4>
                  <select
                    value={selectedSize}
                    onChange={(e) => {
